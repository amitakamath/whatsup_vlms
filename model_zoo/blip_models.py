...
download_urls = {
    ...
    "blip-base-14m": {
        ...
        "config_url": "https://raw.githubusercontent.com/salesforce/BLIP/0480d94d5725a3d1aac66f21e6bf138ac17d323d/configs/pretrain.yaml",
        "bert_config_url": "https://raw.githubusercontent.com/salesforce/BLIP/0480d94d5725a3d1aac66f21e6bf138ac17d323d/configs/med_config.json"
    },
...
class BLIPModelWrapper:
    def __init__(self, root_dir, device, variant="blip-flickr-base"):
        ...
        model = blip_retrieval(pretrained=self.model_path, image_size=config['image_size'], vit=config['vit'], 
                                ...
                                queue_size=config['queue_size'], negative_all_rank=False,
    ...
    @torch.no_grad()
    def get_image_embeddings(self, image_loader, marginalization=False):
        image_feats = []
        image_embeds = []
        if marginalization:
